...
% plot(t,y(:,1),'g',t,y(:,2),'r');
 ...
 ylabel('liczebność populacji *10^7');
 ...
 legend('populacja Polski za pomocą modelu','populacja UK za pomocą modelu','rzeczywsite dane PL','rzeczywiste dane UK','Location','southeast')
 end
...
%p =1; q =1.0876524 ; r =1 ; s = 1
 %a=0.35; b=0.1; c=0.7; d=0.6;   %rodzi sie 350 000 dzieci,migruje 100 000 pl, rodiz się 700 000 dzieci umiera 600 000 ludzi

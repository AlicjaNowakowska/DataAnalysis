...
% hold on
 ...
 %legend('samotni mezczyzni za pomocą modelu','rzeczywsite dane','Location','northwest')
 %xlabel('czas w latach');
 %ylabel('liczebność populacji*10^6');
 %hold on
 %plot(t,y(:,2),'g')
 hold on
 plot(t,y(:,2),'r')
...
% plot(0:11,s_mezczyzni,'g-o')
 ...
 %,'samotni mezczyzni za pomocą modelu' 'samotni mezczyzni-rzeczywiste dane',
